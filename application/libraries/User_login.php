...
class User_login
{
	...
	public function login($username,$password)
	{
		...
		{
				$this->ci->session->set_flashdata('pesan', 'User Name Passord Salah');
				redirect('login');
		}
	}
	...
	public function log_out()
	{
			...
			$this->ci->session->set_flashdata('pesan', 'Log Out Sukses');
			redirect('login');		
	}
...
/* Location: ./application/libraries/User_login */

...
<footer class="footer">
		<div class="footer_background" style="background-image:url(<?php base_Url()?>template/front-end/images/footer_background.png)"></div>
		<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="#">
											<div class="footer_logo_text">SMPK ST. YOSEFA LABUAN BAJO</span></div>
										</a>
									</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									<div class="footer_title">Contact Developer</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib <i class="fa fa-heart-o" aria-hidden="true"></i> and Edited By <a href="https://colorlib.com" target="_blank">Yohanes Erros Sahu	</a></a>

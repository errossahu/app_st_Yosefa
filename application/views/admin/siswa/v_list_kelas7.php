  <div class="col-lg-12">
                            ...
                            <div class="panel-heading col-md-3">
                                    <a href="<?=base_Url('siswa/add')?>" class="btn btn-primary" style='font-size:24px'><h6>SISWA KELAS 9</h6>  <i class='fas fa-list '></i></a>

                                </div>
                                <div class="panel-body">
                                  <br><br>

<h2 class="text-center">Data Siswa Kelas 7</h2>

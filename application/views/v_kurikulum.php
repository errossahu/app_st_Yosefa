...
<div class="row">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th style="width: 5%;" scope="col">Keterangan File</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-center">
                        <a href="<?=base_url('home/download_kurikulum/'.$value->id_file) ?>" class="btn btn-primary btn-sm"><i class="fa fa-download"></i>Download</a>
                      </td>
    </tr>
 <?php }?>
  </tbody>
